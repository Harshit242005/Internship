...
namespace Enhance.Pages
{
    public class LoginModel : PageModel
    {
        ...
        //private readonly string connectionString = "Server=MYSQL8001.site4now.net;Database=db_a9c0b2_zeus;Uid=a9c0b2_zeus;Pwd=azxcvbnmlkjhgfds";
        //private readonly string connectionString = "Server=MYSQL8001.site4now.net;Database=db_a9c0b2_zeus;Uid=a9c0b2_zeus;Pwd=@hRR9s6bg5MUg86";
